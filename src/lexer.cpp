...
namespace MyCustomLang
{
    ...
    Token Lexer::getNextToken()
    {
        ...
        if (isAtEnd())
        {
            // Emit dedents for unclosed indentation levels
        ...
        if (c == '\n')
        {
            advance();
            line++;
            // Skip whitespace to check if line is blank
            ...
            current = new_indent; // Reset position
            ...
            return getNextToken(); // No NEWLINE for non-blank lines
        }
